        ...
        if nOfCurlines == 1 and SimTied == 0:
            ...
            for iCampaignX in range(len(self.doc['scenario'][campaignX])):
                for i in range(len(self.doc['scenario'][curLine])):
                    ...
                    if plotgraph == 'MaxRange':
                        curFileName = ("UL_Results_Sim_PropModel_UanPropModelThorp"+
                                   "_MaxRange_"+str(int(self.MaxRange[iCampaignX]))+
                    ...
                    for iJob in range(0,self.nJobs):
                        ...
                        if metric == 'PLR':
                            ...
                            #Substituir PLR zerada para máxima
                            zeros = Packet_Loss_Ratio == 0
                            Packet_Loss_Ratio[zeros] = 1
                            ...
                            m_metric = np.append(m_metric, np.sum((Nav_Consumption+Modem_Consumption)/1000))
            ...
            if plotgraph == 'MaxRange':
                ...
                #Labels
                xlabel='Distância horizontal do AUV ao Gateway [m]'
                label1 = "Glider"
                label2 = "Remus"
                label3 = "Typhoon"
        ...
        if plotgraph == 'MaxRange':
            if bool(self.plotCI):  
                if metric == 'NavConsumption':
                    ...
                    plt.yscale('log')
                    ax.set_yticks([0.1, 1, 10,100,1000,10000,30000])
